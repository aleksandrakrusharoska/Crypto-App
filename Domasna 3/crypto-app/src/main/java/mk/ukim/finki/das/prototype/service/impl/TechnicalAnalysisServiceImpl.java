...
import mk.ukim.finki.das.prototype.model.technical.FrameIndicators;
import mk.ukim.finki.das.prototype.model.enums.TaSignal;
import mk.ukim.finki.das.prototype.model.technical.SignalStats;
import mk.ukim.finki.das.prototype.model.technical.TechnicalAnalysisResult;
import mk.ukim.finki.das.prototype.model.technical.TimeframeSignal;
...
//        double lastVolume = dailySeries.getLastBar().getVolume().doubleValue();
...
//        double weeklyLastVolume = weeklySeries.getLastBar().getVolume().doubleValue();
...
//        double monthlyLastVolume = monthlySeries.getLastBar().getVolume().doubleValue();
...
//        fi.setVolumeMa(new SMAIndicator(volume, 20).getValue(i).doubleValue());
...
//            double lastVolume
    ...
    private TaSignal getTaSignal(FrameIndicators fi, double lastClose, TimeframeSignal base) {
        TaSignal finalSignal = base.getSignal();
...
//    private boolean isHighVolume(double volume, double volumeMa) {
